...
const FilterGamesSidebar = ({ active, setActive }: any) => {
  return (
    <Sidebar active={active} setActive={setActive}>
      <div className="flex-shrink-0 sticky top-0 ">
        <div className=" flex flex-row p-6 bg-black/50 items-center gap-4">
      ...
      <div className="flex-col flex p-6 gap-6">
        <div className="border-b border-white/10">
          <h3 className="text-xl font-bold">Sort By</h3>
          <div className="w-full rounded-lg my-6 h-20 bg-[#121212] font-semibold overflow-hidden placeholder-white">
            <select className="w-full p-6 h-full bg-[#121212]">
              <option value="1">Newest</option>
              <option value="2">Oldest</option>
              <option value="3">Most Expensive</option>
              <option value="3">Least Expensive</option>
              <option value="3">Highest Reward</option>
              <option value="3">Lowest Reward</option>
            </select>
          </div>
        </div>
        <div className=" border-b border-white/10">
          ...
          <input
            ...
            placeholder="Minimum"
          ></input>
          <div className="m-auto self-start">to</div>
          <input
            className="w-full rounded-lg my-6 h-20 bg-[#121212] font-semibold p-6 placeholder-white"
            placeholder="Maximum"
          ></input>
...
const FilterGamesItem = ({ last }: any) => {
  return (
...
export default FilterGamesSidebar;
